...
class SHA256 {
    ...
    { 
        ...
        for (int i = 0; i <= max_nonce; i++){
            ...
            {   
                ...
                String newhash = toHexString(getSHA(text)); //hashes the text and converts it to a hex string to be stored as a data type
                ...
                //break;
                if (i % 500000 == 0) {
                     System.out.print(n + " | " + newhash + "\r");      //prints every 500000th hash and nonce, to optimize the speed as printing a lot slows it down
                                                                        //carriage return stops the console from being flooded
                }
               
                //checks if the hased text starts with the desired # of zero's, and prints the hash, then exits the program
            ...
            //basic catch statment that throws and exeption if the requirements are not meet and prints it
    ...
    public static String toHexString(byte[] hash)
    {
         ...
         * a hash from SHA256 is a hexadecimal number of 64 digits this means 0 can be padded based upon the missing leading digits
         * /
